package com.example.ashok.webserv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getXmlBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(MainActivity.this, android.R.layout.simple_list_item_1, xmlResultAddresses);
